        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="{{route('logout')}}">Hai, {{Auth::guard('masyarakats')->user()->nama}}</a></li>
                    @else
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Layanan Pengaduan Online Masyarakat</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">Dari masyarakat, oleh masyarakat, untuk masyarakat. Laporkan masalahmu sekarang juga!</h2>
                    @if (Auth::guard('masyarakats')->user())
