...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form action="{{route('admin.masyarakat.update', $masyarakat->nik)}}" method="POST" id="editForm">
            @csrf
            <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Nama</label>
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Nama Petugas" id="nama" name="nama" autocomplete="off" value="{{$masyarakat->nama}}"/>
                @error('nama')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="basic-default-company" placeholder="ACME Inc." id="username" name="username" autocomplete="off" value="{{$masyarakat->username}}"/>
                @error('username')
                    <div class="text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" id="basic-default-phone" class="form-control phone-mask"
                    placeholder="658 799 8941" name="telp" value="{{$masyarakat->telp}}"/>
                    @error('telp')
                    <div class="text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                    <input type="text" id="basic-default-email" class="form-control" placeholder="john.doe"
                        aria-label="john.doe" aria-describedby="basic-default-email2" name="email" value="{{$masyarakat->email}}"/>
