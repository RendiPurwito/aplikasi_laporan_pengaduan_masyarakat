        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item @if (\Request::is('admin/admin-dashboard')) active  @endif">
                    ...
                    <li class="menu-item @if (\Request::is('admin/petugas') || \Request::is('admin/petugas/*')) active  @endif">
                    ...
                    <li class="menu-item @if (\Request::is('admin/pengaduan') || \Request::is('admin/pengaduan/*')) active  @endif">
                    ...
                    <li class="menu-item @if (\Request::is('admin/tanggapan') || \Request::is('admin/tanggapan/*')) active  @endif">
